...
<?php 
$q="SELECT * from tbl_masuk where tbl_masuk.kodetransaksi='$_GET[id]'";
...
$nox=1;
$totalbiaya=0;
$sql1="SELECT tbl_detailmasuk.*,tbl_barang.namabarang as namabarang,tbl_barang.satuan as satuan from tbl_detailmasuk,tbl_barang 
where kodetransaksi='$_GET[id]' and tbl_detailmasuk.kodebarang=tbl_barang.kodebarang";
