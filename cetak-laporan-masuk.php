...
<body>
<div>
  <h3 align=center><u>Laporan Pemasukan Material Hartekdist</u><br>
...
$nox=1;
$totalpenjualan=0;
$sql1="SELECT * from tbl_masuk where tanggaltransaksi BETWEEN '$_POST[tanggalmulai]' AND '$_POST[tanggalakhir]' order by tanggaltransaksi ASC";
...
<tr align="center">
  ...
  <th style="width: 100px">
      <?php
        $qqq="SELECT tbl_detailmasuk.*, tbl_barang.namabarang as namabrg 
        from tbl_detailmasuk,tbl_barang where tbl_detailmasuk.kodetransaksi='$values[kodetransaksi]' 
        AND tbl_detailmasuk.kodebarang=tbl_barang.kodebarang";
  ...
  <th style="width: 100px">
  <?php
        $qqq1="SELECT tbl_detailmasuk.*, tbl_barang.satuan as satuan 
        from tbl_detailmasuk,tbl_barang where tbl_detailmasuk.kodetransaksi='$values[kodetransaksi]' 
        AND tbl_detailmasuk.kodebarang=tbl_barang.kodebarang";
