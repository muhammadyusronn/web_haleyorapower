            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable2" width="100%" cellspacing="0">
                  ...
                  $nox=1;
                  $totalbiaya=0;
                  $qw="SELECT tbl_detailtransaksi.*,tbl_barang.namabarang as namabarang, tbl_barang.satuan as satuan from tbl_detailtransaksi,tbl_barang where kodetransaksi='$_GET[id]' and tbl_detailtransaksi.kodebarang=tbl_barang.kodebarang";
                  // echo "$qw";
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-7">
                  <?php 
                    $qw_ds=mysqli_query($koneksi,"SELECT * from tbl_transaksi where tbl_transaksi.kodetransaksi='$_GET[id]'");
                  ...
                  <form class="user" action="models/m_pembelian.php" method="POST">
                      ...
                      <div class="form-group">
                        <a href="cetak-struk-transaksi.php?id=<?php echo $data['kodetransaksi'] ?>" class="btn btn-success" target="_BLANK"><i class="fas fa-download">&nbsp;</i>DOWNLOAD BUKTI TRANSAKSI</a>
                      </div>
                  </form>
                <?php } ?>
                </div>
