<?php include 'head.php'; ?>
        ...
        <div class="container-fluid">
           <!-- Tabel Detail Order -->
          <?php if (isset($_SESSION['pemasukan_cart'])) { ?>
              ...
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable2" width="100%" cellspacing="0">
                  ...
                  <tfoot>
                    <tr>
                      <th colspan="2"></th>
                      <th><a href="v_transaksi-barang-masuk.php?cancel=true" onclick="javascript: return confirm('Apakah anda yakin membatalkan transaksi?');" class="btn btn-danger">CANCEL</a></th>                    
                    </tr>
                  </tfoot>
                  <tbody>
                  <?php 
        ...
        <?php } ?>
          <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Form Checkout Transaksi Masuk</h6>
            </div>
            <div class="card-body">
              <div class="row">
                <div class="col-7">
                  <form class="user" name="form1" action="models/m_transaksi-masuk.php" method="POST">
